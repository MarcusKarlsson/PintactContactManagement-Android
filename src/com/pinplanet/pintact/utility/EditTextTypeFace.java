 ...
 * @author Dennis
 * 
 * this EditText uses custom fonts instead of the default font
 * */
public class EditTextTypeFace extends EditText {

	private static final String TAG=EditTextTypeFace.class.getName();
	...
	public EditTextTypeFace(Context context, AttributeSet attrs, int defStyle) {
