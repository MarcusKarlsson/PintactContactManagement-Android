    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR.equals(messageType)) {
                ...
                sendNotification("Deleted messages on server: " + extras.toString(), extras.getString("customData"));
...
//        SingletonLoginData.getInstance().mNotificationManager = mNotificationManager;
    ...
    private void sendDefaultNotification() {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.drawable.ic_launcher)
                        .setContentTitle("Pintact Notification")
                        .setStyle(new NotificationCompat.BigTextStyle()
                                .bigText("New notification from Pintact"))
                        .setVibrate(new long[]{1000, 1000, 1000, 1000, 1000})
