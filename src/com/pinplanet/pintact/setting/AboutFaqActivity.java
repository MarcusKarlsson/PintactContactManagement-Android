...
public class AboutFaqActivity extends MyActivity{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    tv.setText(getResources().getString(R.string.about_setting_faq));

    WebView myWebView = (WebView) findViewById(R.id.webview);
    myWebView.getSettings().setJavaScriptEnabled(true);
    myWebView.loadUrl("file:///android_asset/html/faq.html");
  }
}
